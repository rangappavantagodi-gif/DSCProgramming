...
- Modular programming with separate functions for input and output.

---

## 🛠️ Features
- Handles any number of students (entered at runtime).
- Reads student details using a dedicated function.
- Displays student details neatly using another function.
- Demonstrates array handling and function calls with structures.
...
- How to manage user input and output effectively.

🔮 Possible Extensions
- Add support for reading names with spaces (fgets).
- Calculate and display average marks of all students.
- Sort students by marks or age.
- Save student details to a file for persistence.
